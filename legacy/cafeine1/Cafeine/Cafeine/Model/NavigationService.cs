...
namespace Cafeine.Model {
    ...
    /// </summary>
    public interface ICafeineNavigationService {
        /// <summary>
    ...
    class CafeineNavigationService : ICafeineNavigationService {
        ...
        private static Frame AppFrame => ((Window.Current.Content as Frame)?.Content as HomePage)?.Vm.F;
