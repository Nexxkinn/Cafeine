...
namespace Cafeine.Services.Api
{
    public static class MyAnimeList
    {
        ...
        public static async Task<List<OfflineItem>> GetUserData(bool IsDefaultService)
        {
            ...
            //List<OfflineItem> Item = new List<OfflineItem>();
            ...
            //    {
            //        Item.Add(new OfflineItem
            //        {

            //            MalID = (int)item.Element("series_animedb_id"),
            //            Service = new Dictionary<string, ServiceItem>
            //            {
            //                [ServiceName] = new ServiceItem
            //                {
            //                    Title = item.Element("series_title").Value,
            //                    Episodes_Chapters = (int)item.Element("series_episodes"),
            //                    SeriesStart = Convert.ToInt32(item.Element("series_start").Value.Take(4).ToString()),
            //                    MediaType = "Anime",
            //                    Service = (int)item.Element("series_animedb_id"),
            ...
            //                    MediaType = "Manga",
            //                    Title = item.Element("series_title").Value,
            //                    Episodes_Chapters = (int)item.Element("series_chapters"),
            //                    SeriesStart = Convert.ToInt32(item.Element("series_start").Value.Take(4).ToString()),
